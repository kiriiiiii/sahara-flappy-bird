...
class Bird extends GameObject {
    ...
    public Bird(int x, int y){
        super(x, y);
        if(proxyImage == null) {
            proxyImage = new ProxyImage("4bird.png"); // Load the image of the bird
        }
    ...
    public void tick() {
        if(dy < 3) { // If the speed of the bird is less than 5
...
class Game extends JPanel implements ActionListener {
    ...
    public Game() {
        ...
        proxyImage = new ProxyImage("4desert.jpg"); // Load the image
...
class Window {
    ...
    public static void main(String[] args) {
        ...
        try
        {
            filePath = "C:\\Users\\HP\\OneDrive\\Desktop\\java practice\\music\\music\\src\\Epic Arabian Music  Golden Age (mp3cut.net).wav";
